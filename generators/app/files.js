...
const SERVER_TEMPLATE_DIR = `${__dirname}/templates/server`;
...
function writeServerFiles() {
    ...
    this.writeFilesToDisk(serverFiles, this, false, SERVER_TEMPLATE_DIR);
}

function writeEnumServerFiles() {
    this.fields.forEach(field => {
        if (field.fieldIsEnum === true) {
            ...
            if (!this.skipServer) {
                this.template(
                    `${SERVER_TEMPLATE_DIR}/${SERVER_MAIN_SRC_DIR}package/domain/enumeration/Enum.java.ejs`,
