...
function askForPageConfig() {
    ...
    const prompts = [
        ...
        },
        {
            ...
            name: 'pageGlyphIcon',
            message:
                'Enter the optional page icon name in font awesome for angular or glyphicon for angularjs (cloud-upload-alt for example):'
        },
        {
            when: this.regenerate,
            type: 'checkbox',
    ...
    const prompts = [
        ...
        },
        {
            when: response =>
                ...
                (response.fieldType === 'String' || response.fieldTypeBlobContent === 'text'),
            type: 'checkbox',
        ...
        {
            when: response =>
                response.fieldAdd === true && response.fieldValidate === true && response.fieldValidateRules.indexOf('minlength') !== -1,
            type: 'input',
        ...
        {
            when: response =>
                response.fieldAdd === true && response.fieldValidate === true && response.fieldValidateRules.indexOf('maxlength') !== -1,
            type: 'input',
        ...
        },
        {
            when: response =>
                ...
                (response.fieldType === 'Integer' || response.fieldType === 'Long'),
            type: 'input',
        ...
        },
        {
            when: response =>
                ...
                response.fieldValidate === true &&
                response.fieldValidateRules.indexOf('min') !== -1 &&
                (response.fieldType === 'Float' || response.fieldType === 'Double' || response.fieldType === 'BigDecimal'),
            type: 'input',
            name: 'fieldValidateRulesMin',
            message: 'What is the minimum of your field?',
        ...
        {
            when: response =>
                response.fieldAdd === true && response.fieldValidate === true && response.fieldValidateRules.indexOf('pattern') !== -1,
            type: 'input',
